...
- 対象fixture
- 比較したgolden revision
- 入力document idまたはhash
- 使用model
- prompt versionまたはhash
- case data schema version
- application比較をした場合のmapping version/hash
...
再監査後の契約は、8 fixture、577 field rules、287 extraction、218 application_only、72 excluded、needs_review 0、unclassified 0、manifest path error 0。同じAI runの再採点は260/287 = 90.6%だが、これはモデル改善ではなく評価データ修正の影響である。
