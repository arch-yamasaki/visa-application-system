...
_describe_field(_S2_EMPLOYMENT, "job_category_primary", "Exact RASENS select label for the planned job category. Use 建築・土木・測量技術 Architecture, civil engineering, surveying techniques for architecture/civil/surveying work and 管理業務（経営者を除く） Management work (excluding executives) for management work.")
