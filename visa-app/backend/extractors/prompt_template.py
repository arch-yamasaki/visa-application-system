...
- 値が見つからない場合は value を空文字、source_ref は `{{"document_id": "", "page": 0, "text_quote": "", "confidence": 0}}` とし review の missing_items に記録
...
OK: `{{"value": "", "source_ref": {{"document_id": "", "page": 0, "text_quote": "", "confidence": 0}}}}` （値が見つからない場合）
...
- 値が見つからない場合は value を空文字、source_ref を `{"document_id": "", "page": 0, "text_quote": "", "confidence": 0}` とすること
- **source_ref が空のまま value が非空であることは禁止。** 値を出力するなら source_ref は必ず根拠書類を示すこと。
