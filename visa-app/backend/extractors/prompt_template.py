...
_SCOPE_INSTRUCTIONS: dict[str, str] = {
    ...
    "employer": (
        ...
        "canonical v2 の `employer.*` と `employment.*` として、契約形態、会社名、法人番号、支店名、雇用保険番号、業種、所在地、"
    ...
    "education": (
        ...
        "canonical v2 の `applicant.education[]` と `applicant.qualifications.*` として、最終学歴区分、学校名、卒業年月日、専攻・専門分野、"
